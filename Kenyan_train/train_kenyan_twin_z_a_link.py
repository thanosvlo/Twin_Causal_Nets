...
import pandas as pd
from models_kenyan import Single_Twin_Net_Kenyan, dice_loss, Twin_Net_Kenyan, Twin_Net_Kenyan_with_Z_A
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str,
                        default='twin_net_arch_{}_azlink_{}_uy_{}_uy_monotonicity_{}_z_monoton_{}_z_layer_{}_calib_units_{}_z_{}_lr_{}_loss_{}_1_075_kenyan{}_confounders_{}')
    ...
    # Model Hparams
    parser.add_argument('--lattice_sizes', default=[5,5])
    parser.add_argument('--lr', type=float, default=1e-3)
    parser.add_argument('--epochs', type=int, default=2000)
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--lattice_units', type=int, default=1)  # 1 or 2
    parser.add_argument('--hidden_dims', type=int, default=5)
    parser.add_argument('--calib_units', type=int, default=5)
    parser.add_argument('--z_calib_units', type=int, default=5)
